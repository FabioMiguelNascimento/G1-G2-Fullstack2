          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardContent>
                <div className="flex space-x-4">
                  <img
                    src="https://www.pngarts.com/files/3/Computer-Desktop-PC-PNG-Pic.png"
                  ...
                  <div className="flex-1">
                    <Badge
                      variant="secondary"
                      className="text-primary bg-primary/10 mb-2 text-xs"
                    >
                      DESIGN
                    </Badge>
            ...
            <Card>
              <CardContent>
                ...
                <p className="text-primary mt-2 text-sm">
                  Eba, você ganhou US$ 10 de desconto!
                </p>
              </CardContent>
            </Card>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-2">
                ...
                >
                  Ao clicar aqui, você concorda com nossos{" "}
                  <a
                    href="#"
